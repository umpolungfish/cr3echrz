...
| Engine | Contents |
|--------|----------|
| **p3theorem** (`code/unified_driver.py`) | 7 operationalized mathematical theorems |
| **ob3ect_vault** (`ob3ect_vault/main.py`) | 313 self-verifying digital ob3ects |
...
Contents: 12-opcode reference and 12 canonical sequences, Belnap FOUR logic,
Frobenius verification, Lean 4 companions, CLINK L8 context, the Wormwood
Suite (12 ob3ects), tier ladder, execution modes, directory map. Full
579-line original in `README_backups/cr3echrz_README.md`. Unlicense.
