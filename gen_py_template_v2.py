#!/usr/bin/env python3
"""Generate minimal _ob3ect.py files for vault entries missing them — v2 with proper imports."""
    ...
    for d in sorted(VAULT.iterdir()):
        ...
        if json_path.exists():
            try:
                ...
                description = p0.get('domain_name', desc.get('name', description))[:120].replace("'", "\\'").replace('"', '\\"')
            except Exception:
                pass
